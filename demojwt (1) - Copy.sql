...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 25, 2021 lúc 08:52 AM
...
(47, '[{\"id\":\"5\",\"soluong\":2},{\"id\":\"6\",\"soluong\":5},{\"id\":\"zi0q1vw0j7\",\"soluong\":1},{\"id\":\"e5o35tuplv\",\"soluong\":1},{\"id\":\"jfze32jrrz\",\"soluong\":1}]', 600000, 1, '2021-09-05 13:09:07', '2021-11-13 15:34:39', 1),
...
(51, '[{\"id\":\"8\",\"soluong\":2},{\"id\":\"4\",\"soluong\":1}]', 550000, 0, '2021-11-13 16:07:05', NULL, 5),
(52, '[{\"id\":\"8\",\"soluong\":1}]', 150000, 0, '2021-11-13 16:15:35', NULL, 5),
(53, '[{\"id\":\"8\",\"soluong\":3},{\"id\":\"95\",\"soluong\":1},{\"id\":\"4\",\"soluong\":1}]', 1000000, 0, '2021-11-14 10:48:36', NULL, 5),
(54, '[{\"id\":\"4\",\"soluong\":1}]', 250000, 0, '2021-11-14 10:49:09', NULL, 5),
(55, '[{\"id\":\"8\",\"soluong\":1}]', 150000, 0, '2021-11-14 10:50:06', NULL, 5),
(56, '[{\"id\":\"93\",\"soluong\":1}]', 15000, 0, '2021-11-25 13:50:10', NULL, 5);
...
('88', 'Mực ', 'uploads/oyc76gab_MonAn.jpg', '100000', '', '9', 0, '2021-08-23 00:00:00'),
...
--
ALTER TABLE `hoadon`
  MODIFY `idhoadon` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `thongke`
  ADD CONSTRAINT `thongke_ibfk_1` FOREIGN KEY (`id`) REFERENCES `users` (`id`);
COMMIT;
